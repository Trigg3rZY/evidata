...
const dict = {
  en: {
    ...
    adminFieldHost: 'Host',
    adminFieldPort: 'Port',
    adminFieldDatabase: 'Database',
    adminFieldSslMode: 'SSL mode',
    adminFieldReadOnlyRole: 'Read-only role',
    adminFieldPassword: 'Password',
    adminActionTest: 'Test',
    adminActionEdit: 'Edit',
    adminActionIntrospect: 'Introspect',
    adminActionDelete: 'Delete',
    adminTesting: 'Testing…',
    adminSaving: 'Saving…',
    adminFailed: 'Failed',
    adminHealthPrefix: 'Health:',
    adminHealthHealthy: 'Healthy',
    adminHealthUntested: 'Untested',
    adminHealthAuthFailed: 'Auth failed',
    adminHealthUnreachable: 'Unreachable',
    adminHealthRoleCanWrite: 'Role can write',
    adminHealthUnknown: 'Unknown',
    adminNavAria: 'Admin sections',
    adminConnectionsTitle: 'Connections',
    adminConnectionsNew: 'New connection',
    adminConnectionsEdit: 'Edit connection',
    adminConnectionsEmpty: 'No connections yet.',
    adminConnectionsSave: 'Save connection',
    adminConnectionsTest: 'Test connection',
    adminConnectionsSaveError: 'Could not save the connection.',
    adminConnectionsTestFailed: 'Test failed.',
    adminConnectionsTables: 'tables',
    adminConnectionsPartial: '(partial)',
    adminConnectionsRolePlaceholder: 'Leave blank to keep saved role',
    adminConnectionsPasswordPlaceholder: 'Leave blank to keep saved password',
    adminConnectionsDeleteTitle: 'Delete this connection?',
    adminConnectionsDeleteDescription: 'This action cannot be undone.',
    adminConnectionsRoleCanWriteHint:
      'This role can write. Use a read-only role; this warning does not block use.',
    adminModelsTitle: 'Models',
    adminModelsEmpty: 'No models yet.',
    adminModelsRegister: 'Register a model',
    adminModelsHelp:
      'Configure a model for the whole team — the key is encrypted at rest and never returned, and every member can select it. Leave Base URL empty to use the vendor default; an OpenAI-compatible or self-hosted endpoint needs an explicit one.',
    adminModelsDeleteConfirm:
      'Delete this shared model? Members can no longer select it, and its stored API key is removed.',
    adminModelsCreateError: 'Could not register the model.',
    adminModelsReachable: 'Reachable',
    adminModelsInvalidApiKey: 'Invalid API key',
    adminModelsNoBaseUrl: 'No base URL',
    adminModelsNeedsBaseUrl: 'Needs base URL',
    adminModelsNeedsBaseUrlTitle: 'No base URL resolves — add a Base URL to use this model.',
    adminModelsError: 'Error',
    adminModelsRegistering: 'Registering…',
    adminModelsRegisterAction: 'Register model',
    adminModelsNamePlaceholder: 'Team DeepSeek',
    adminModelsKind: 'Kind',
    adminModelsBaseUrl: 'Base URL (optional)',
    adminModelsApiKey: 'API key',
    adminModelsToolChoice: 'Tool choice (optional)',
    adminModelsTemperature: 'Temperature (optional)',
    adminModelsEffort: 'Effort (optional)',
    adminModelsMaxTokens: 'Max tokens (optional)',
    commonSave: 'Save',
    commonCancel: 'Cancel',
  },
  'zh-CN': {
    ...
    adminFieldHost: '主机',
    adminFieldPort: '端口',
    adminFieldDatabase: '数据库',
    adminFieldSslMode: 'SSL 模式',
    adminFieldReadOnlyRole: '只读角色',
    adminFieldPassword: '密码',
    adminActionTest: '测试',
    adminActionEdit: '编辑',
    adminActionIntrospect: '内省',
    adminActionDelete: '删除',
    adminTesting: '测试中…',
    adminSaving: '保存中…',
    adminFailed: '失败',
    adminHealthPrefix: '健康状态:',
    adminHealthHealthy: '正常',
    adminHealthUntested: '未测试',
    adminHealthAuthFailed: '认证失败',
    adminHealthUnreachable: '无法连接',
    adminHealthRoleCanWrite: '角色可写',
    adminHealthUnknown: '未知',
    adminNavAria: '管理分区',
    adminConnectionsTitle: '连接',
    adminConnectionsNew: '新建连接',
    adminConnectionsEdit: '编辑连接',
    adminConnectionsEmpty: '还没有连接。',
    adminConnectionsSave: '保存连接',
    adminConnectionsTest: '测试连接',
    adminConnectionsSaveError: '无法保存连接。',
    adminConnectionsTestFailed: '测试失败。',
    adminConnectionsTables: '个表',
    adminConnectionsPartial: '(部分)',
    adminConnectionsRolePlaceholder: '留空则保留已保存角色',
    adminConnectionsPasswordPlaceholder: '留空则保留已保存密码',
    adminConnectionsDeleteTitle: '删除此连接?',
    adminConnectionsDeleteDescription: '此操作无法撤销。',
    adminConnectionsRoleCanWriteHint: '此角色可以写入。建议改用只读角色;此警告不阻塞使用。',
    adminModelsTitle: '模型',
    adminModelsEmpty: '还没有模型。',
    adminModelsRegister: '注册模型',
    adminModelsHelp:
      '为整个团队配置模型——密钥会加密保存且不会返回，所有成员都可选择。Base URL 留空则使用厂商默认地址;OpenAI-compatible 或自托管端点需要显式填写。',
    adminModelsDeleteConfirm: '删除这个共享模型?成员将无法再选择它,已保存的 API key 也会被移除。',
    adminModelsCreateError: '无法注册模型。',
    adminModelsReachable: '可连接',
    adminModelsInvalidApiKey: 'API key 无效',
    adminModelsNoBaseUrl: '缺少 Base URL',
    adminModelsNeedsBaseUrl: '需要 Base URL',
    adminModelsNeedsBaseUrlTitle: '无法解析 Base URL——请添加 Base URL 后再使用此模型。',
    adminModelsError: '错误',
    adminModelsRegistering: '注册中…',
    adminModelsRegisterAction: '注册模型',
    adminModelsNamePlaceholder: '团队 DeepSeek',
    adminModelsKind: '类型',
    adminModelsBaseUrl: 'Base URL(可选)',
    adminModelsApiKey: 'API key',
    adminModelsToolChoice: '工具选择(可选)',
    adminModelsTemperature: 'Temperature(可选)',
    adminModelsEffort: 'Effort(可选)',
    adminModelsMaxTokens: 'Max tokens(可选)',
    commonSave: '保存',
    commonCancel: '取消',
  },
} as const;
