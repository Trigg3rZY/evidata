...
const dict = {
  en: {
    ...
    membersDraftQuerierHint:
      'Draft source: Queriers can join now, but cannot see this source until it is Published.',
    membersCopy: 'Copy',
    ...
    inviteJoinedTitle: 'Joined Data Source',
    inviteJoinedSource: 'Source',
    inviteJoinedRole: 'Role',
    inviteUnpublishedHint:
      'This source is not Published yet. It will appear in Ask Data after an Owner publishes it.',
    inviteGoHome: 'Go home',
  ...
  'zh-CN': {
    ...
    membersDraftQuerierHint: '草稿数据源：查询者可以先加入，但发布前不会在问答里看到它。',
    membersCopy: '复制',
    membersCopied: '已复制',
    ...
    inviteJoinedTitle: '已加入数据源',
    inviteJoinedSource: '数据源',
    inviteJoinedRole: '角色',
    inviteUnpublishedHint: '此数据源尚未发布。所有者发布后，它才会出现在数据问答里。',
    inviteGoHome: '回首页',
