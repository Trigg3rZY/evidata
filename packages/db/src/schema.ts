...
export const investigations = meta.table('investigations', {
  ...
  // model answered for audit. Null = fixture-backed anonymous Sample or a legacy
  // unbound row. No FK — the raw id is kept for audit even if the provider is deleted.
  ...
  // records which registered model answered even if the provider is later edited.
